...
namespace EDCOperationsAPI.Controllers.Administration
{
    ...
    public class ContactCategoryController : Controller
    {
        ...
        public ContactCategoryController(BoAppDB db)
        {
            Db = db;
        }
        ...
        public async Task<IActionResult> GetAll()
        {
            ...
            var query = new BoService.Models.Administration.ContactCategoryQuery(Db);
        ...
        [HttpPost]
        public async Task<Dictionary<string, object>> Post([FromBody] BoService.Models.Administration.ContactCategory body)
        {
            await Db.Connection.OpenAsync();
            var query = new BoService.Models.Administration.ContactCategoryQuery(Db);
        ...
        [HttpPut("{id}")]
        public async Task<Dictionary<string, object>> PutOne(int id, [FromBody] BoService.Models.Administration.ContactCategory body)
        {
            Dictionary<string, object> response = new Dictionary<string, object>();
