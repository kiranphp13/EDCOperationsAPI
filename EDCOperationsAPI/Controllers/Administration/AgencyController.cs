...
namespace EDCOperationsAPI.Controllers.Administration
{
    ...
    public class AgencyController : Controller
    {
        ...
        public async Task<IActionResult> GetAll()
        {
            ...
            var query = new BoService.Models.Administration.AgencyQuery(Db);
        ...
        [HttpPost]
        public async Task<Dictionary<string, object>> Post([FromBody] BoService.Models.Administration.Agency body)
        {
            await Db.Connection.OpenAsync();
            var query = new BoService.Models.Administration.AgencyQuery(Db);
        ...
        [HttpPut("{id}")]
        public async Task<Dictionary<string, object>> PutOne(int id, [FromBody] BoService.Models.Administration.Agency body)
        {
            Dictionary<string, object> response = new Dictionary<string, object>();
