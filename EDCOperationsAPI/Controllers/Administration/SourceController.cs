...
namespace EDCOperationsAPI.Controllers.Administration
{
    ...
    public class SourceController : Controller
    {
        ...
        public SourceController(BoAppDB db)
        {
            Db = db;
        }
        ...
        public async Task<IActionResult> GetAll()
        {
            ...
            var query = new BoService.Models.Administration.SourceQuery(Db);
        ...
        [HttpPost]
        public async Task<Dictionary<string, object>> Post([FromBody] BoService.Models.Administration.Source body)
        {
            await Db.Connection.OpenAsync();
            var query = new BoService.Models.Administration.SourceQuery(Db);
        ...
        [HttpPut("{id}")]
        public async Task<Dictionary<string, object>> PutOne(int id, [FromBody] BoService.Models.Administration.Source body)
        {
            Dictionary<string, object> response = new Dictionary<string, object>();
